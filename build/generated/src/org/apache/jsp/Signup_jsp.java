...
public final class Signup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            if(name==\"\" || email==\"\" || mobile==\"\" || password==\"\")\n");
      out.write("            {\n");
      ...
      out.write("            xmlhttp.open(\"POST\",\"check\",true);\n");
      out.write("            xmlhttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');\n");
      out.write("            xmlhttp.send(\"name=\"+name +\"&email=\"+ email+\"&mobile=\"+mobile+\"&password=\"+password);\n");
      ...
      out.write("                if(x == \"\")\n");
      out.write("                { \n");
      out.write("                         document.getElementById(\"show_div\").innerHTML=\"Wait for Confirmation\";\n");
      out.write("\n");
      out.write("                }\n");
      out.write("                else {\n");
      ...
      out.write("        <input type=\"password\" name=\"pasword\" id=\"password\" required><br>\n");
      out.write("        <label>Mobile Number</label><br>\n");
      out.write("        <input type=\"text\" name=\"mobile\" id=\"mobile\" required><br>\n");
      out.write("        <input type=\"submit\" onclick=\"sendreq()\"  value=\"Sign Up\"/><br>                  \n");
